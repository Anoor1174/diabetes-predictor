...
def compute_performance_fairness_comparison(thresholds):
    """Run a threshold sweep and pull out the Pareto frontier.

    We want HIGH recall, HIGH accuracy, LOW fairness gap. A point is
    dominated if another point is at least as good on all three and
    strictly better on at least one.

    Returns:
        all_points: DataFrame of every threshold result
        frontier: DataFrame of the non-dominated (Pareto-optimal) points
    """
